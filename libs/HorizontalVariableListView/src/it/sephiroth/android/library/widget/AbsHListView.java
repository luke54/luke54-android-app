...
public abstract class AbsHListView extends AdapterView<ListAdapter> implements ViewTreeObserver.OnGlobalLayoutListener,
	...
	/**
	 * The last scroll state reported to clients through {@link it.sephiroth.android.library.widget.AbsHListView.OnScrollListener}.
	 */
	...
	static class SavedState extends BaseSavedState {
		...
		/**
		 * Constructor called from {@link it.sephiroth.android.library.widget.AbsHListView#onSaveInstanceState()}
		 */
