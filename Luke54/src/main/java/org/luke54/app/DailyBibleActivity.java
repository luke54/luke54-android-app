...
import org.luke54.app.Article;

public class DailyBibleActivity extends ImageLoadingListActivity {
...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
    ...
    public void work(){
        ...
        String url = "http://www.luke54.org/components/com_mobileapp/androidBible.json";
    ...
    public void renderArticles(String url, JSONArray jsonArray, AjaxStatus status) throws Exception{
        ...
        aq.id(R.id.list).itemClicked(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(DailyBibleActivity.this, ArticleActivity.class);
...
//        aq.scrolledBottom(this, "scrolledBottom");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.daily_bible, menu);
        return true;
    }
